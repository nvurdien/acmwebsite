      ...
      <div class="uk-container">
          ...
          <div class="uk-child-width-1-3@m uk-child-width-1-2@s" uk-grid>
              ...
              <div>
                  ...
                  <p>
                    <a href="https://www.twitter.com/acmcsuf" aria-label="twitter link" target="_blank" title="@acmcsuf" uk-tooltip="pos: bottom" class="uk-icon-button uk-margin-small-right" uk-icon="icon: twitter"></a>
                    <a href="https://www.facebook.com/groups/acmcsuf" aria-label="facebook group link" target="_blank" title="/group/acmcsuf" uk-tooltip="pos: top" class="uk-icon-button uk-margin-small-right" uk-icon="icon: facebook"></a>
                    <a href="https://www.instagram.com/acmcsuf" aria-label="instagram link" target="_blank" title="@acmcsuf" uk-tooltip="pos: right" class="uk-icon-button uk-margin-small-right" uk-icon="icon: instagram"></a>
                  </p>
              </div>
